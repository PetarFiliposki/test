...
public class ChefServiceImpl implements ChefService {
    ...
    public Chef addDishToChef(Long chefId, String dishId) {
        ...
        if (chef != null && dish != null) {
            chef.getDishes().add(dish);  // getDishes() работи со Lombok или getter
            dish.setChef(chef);          // поврзи Dish со Chef
            dishRepository.save(dish);   // зачувај ја промената во базата
        }
